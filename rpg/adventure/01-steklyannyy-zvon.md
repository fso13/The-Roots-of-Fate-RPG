...
- Сгенерируйте иллюстрации по **[промптам для нейросетей](prompts-topdown-maps.md)** или откройте уже лежащие **PNG** в `maps/` (раздел ниже).
...
## Карты и иллюстрации (вид сверху)

**Рекомендуется:** готовые **промпты** (RU + EN) для генерации красочных карт в нейросетях — файл **[prompts-topdown-maps.md](prompts-topdown-maps.md)**. Сохраните результат как PNG в `maps/` с именами из шпаргалки в том файле.

Готовые **PNG** (если уже сгенерированы или лежат в репозитории):

| Карта | Файл |
|-------|------|
| Город **Серый причал** | [maps/01-gorod-seryy-prichal.png](maps/01-gorod-seryy-prichal.png) |
| Таверна **«У трёх бочек»** (социалка / драка) | [maps/02-taverna-tri-bochki.png](maps/02-taverna-tri-bochki.png) |
| **Запруда и мост** (погоня / засада) | [maps/03-zapruda-most.png](maps/03-zapruda-most.png) |
| **Библиотека обители** (детектив) | [maps/05-biblioteka-obitel.png](maps/05-biblioteka-obitel.png) |
| **Камера под колоколом** (финал) | [maps/04-kamora-kolokol.png](maps/04-kamora-kolokol.png) |

*Если файлов ещё нет — картинки в Markdown ниже не отобразятся; это нормально.*

![Город Серый причал](maps/01-gorod-seryy-prichal.png)

![Таверна](maps/02-taverna-tri-bochki.png)

![Запруда](maps/03-zapruda-most.png)

![Библиотека](maps/05-biblioteka-obitel.png)

![Камера финала](maps/04-kamora-kolokol.png)
...
**Карта:** район обители на [карте города](maps/01-gorod-seryy-prichal.png) — колокольня у храма.
...
**Карта:** [02-taverna-tri-bochki.png](maps/02-taverna-tri-bochki.png).
...
**Карта:** [03-zapruda-most.png](maps/03-zapruda-most.png).
...
**Карта:** [05-biblioteka-obitel.png](maps/05-biblioteka-obitel.png).
...
**Карта:** [04-kamora-kolokol.png](maps/04-kamora-kolokol.png).
