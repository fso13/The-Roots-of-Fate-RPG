...
Готовые блоки угроз для фэнтези-сцен: от ополченца до дракона, в одной механике с ядром.

*Требует [Глава 2. Бестиарий](../06-bestiariy.md) и модуль боя. ЧЦ защиты: **8 + Ловкость + доспех**.*

Ниже — существа **в духе** отрядов *Heroes of Might and Magic* (V и др.) и классического фэнтези. Это не официальные статы игры, а перевод в «Корни судьбы».

> **За столом.** Иллюстрации — арты из **Heroes of Might and Magic V** (Ubisoft / Nival). **Бонус** — слагаемое в **(итог атаки − ЧЦ) + бонус**. **ЧЦ** без строки в блоке считайте из атрибутов и доспеха.
...
- **Особое:** союзники **Рядом** **+1** к страху/морали (нарратив); иммун к обычному **страху** (стресс от запугивания — по хранителю).
...
- **Раны 7**  
- **Две сабли +1** (двойное оружие — вторая атака по талантам хранителя)  
...
- **Раны 20**  
- **Укусы +3** (несколько голов — **две** атаки за раунд по **1 ОД** каждая или одна **+2** к бонусу — по хранителю)  
